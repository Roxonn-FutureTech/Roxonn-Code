...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Roxonn Code",
	FIX: "Fix with Roxonn Code",
	IMPROVE: "Improve with Roxonn Code",
	ADD_TO_CONTEXT: "Add to Roxonn Code",
	NEW_TASK: "New Roxonn Code Task",
} as const
