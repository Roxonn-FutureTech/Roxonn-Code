...
export const SettingsFooter = ({ version, className, ...props }: SettingsFooterProps) => (
	<div className={cn("text-vscode-descriptionForeground p-5", className)} {...props}>
		<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
			...
			<VSCodeLink href="https://github.com/roxonn/roxonn-code" style={{ display: "inline" }}>
				github.com/roxonn/roxonn-code
			</VSCodeLink>{" "}
			or join{" "}
			<VSCodeLink href="https://www.reddit.com/r/roxonn/" style={{ display: "inline" }}>
				reddit.com/r/roxonn
			</VSCodeLink>
		</p>
		<p className="italic">Roxonn Code v{version}</p>
